...
class TrainData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if width < crop_width or height < crop_height:
            if width < height:
                haze_img = haze_img.resize((612, (int)(height * 612/ width)), Image.ANTIALIAS)
                gt_img = gt_img.resize((612, (int)(height * 612/ width)), Image.ANTIALIAS)
            elif width >= height:
                haze_img = haze_img.resize(((int)(width * 612/ height), 612), Image.ANTIALIAS)
                gt_img = gt_img.resize(((int)(width * 612 / height), 612), Image.ANTIALIAS)
...
class ValData(data.Dataset):
    def __init__(self, val_data_dir):
        ...
        self.haze_dir = val_data_dir + '/hase/'
